  ...
  <div className="bg-primary w-screen h-screen px-8 flex flex-col items-center">
    ...
    <!-- <div v-if="voteByVoteIdResult" className="h-screen w-screen flex flex-col items-center justify-center -mt-28">
        <div>
            ...
            <input type="text" className="w-72 h-9 rounded-xl mt-2 px-3" placeholder="Name of the match MVP">
        </div>
        <div v-if="voteByVoteIdResult.voteByVoteId.comments" className="mt-4">
            ...
            <textarea className="w-72 h-28 rounded-xl mt-2 px-3 p-2" placeholder="Name of the match MVP"></textarea>
        </div>
    ...
    <button v-if="voteByVoteIdResult" className="bg-secondary text-primary w-56 text-2xl font-gill rounded-xl absolute bottom-16 p-2">Send vote</button> -->
